...
### [我的博客在这里 &rarr;](http://zhuizhuhaomeng.github.io)
...
```
# Site settings
title: zhuizhuhaomeng Blog             # 你的博客网站标题
SEOTitle: zhuizhuhaomeng Blog			# 在后面会详细谈到
...
我的博客标题是 **“zhuizhuhaomeng Blog”** 但是我想要在搜索的时候显示 **“追逐好梦的博客 | zhuizhuhaomeng Blog”** ，这个就需要SEO Title来定义了。
